...
# main
feature = 3 # 0 = sepal length, 1 = sepal width, 2 = petal length, 3 = petal length

selectionSort(feature, feature_data_copy, label_copy)

printSpeciesData(feature, feature_data_copy, label_copy, target_names)

printMinMax_SLen(feature, feature_data_copy)